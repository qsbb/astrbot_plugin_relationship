...
class PagesUiTest(unittest.TestCase):
    ...
    def test_page_assets_have_cache_stamp(self) -> None:
        self.assertIn("style.css?v=0.12.4-1", self.html)
        self.assertIn("series-ui.css?v=0.12.4-1", self.html)
        self.assertIn("series-ui.js?v=0.12.4-1", self.html)
        self.assertIn("app.js?v=0.12.4-1", self.html)
